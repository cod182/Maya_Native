...
export const getUserBookmarks = async (userId) => {
  try {
    const posts = await databases.listDocuments(
      databaseId,
      videoCollectionId, [Query.contains("bookmarked_by", userId)]
    );
...
// export const bookmarkPost = async (typeOfCall, userId, videoId, bookmarkedArray) => {
//   try {
//     let newBookmarkedArray = bookmarkedArray

//     // Check if the functions is to add the bookmark or remove it
//     if (typeOfCall === 'add') {
//       if (!bookmarkedArray.includes(userId)) {
...
//         }
//         // Push current user into the newBookmarkedArray
//         newBookmarkedArray.push(newBookmarkObject);
//       } else {
//         Alert.alert('You have already bookmarked this post')
//       }
//     } else if (typeOfCall === 'remove') {
//       if (bookmarkedArray.includes(userId)) {
//         // Push current user into the newBookmarkedArray
//         newBookmarkedArray.pop(userId);
//       } else {
//         Alert.alert('You have not bookmarked this post')
//       }
//     }

//     // Update the post with the newBookemarkedArray
//     const updatedPost = await databases.updateDocument(
//       databaseId,
//       videoCollectionId,
//       videoId, {
//       bookmarked_by: newBookmarkedArray,
//     }
//     );
